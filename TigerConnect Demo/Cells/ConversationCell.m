...
@property (weak, nonatomic) IBOutlet AvatarView *avatarImageView;
...
- (void)setItem:(TTRosterEntry *)item
{
    ...
    [self.avatarImageView loadImageForParty:_item.target];
}
...
- (void)setConversationNameFont:(UIFont *)conversationNameFont
{
    _conversationNameFont = conversationNameFont;
    self.conversationNameLabel.font = _conversationNameFont;
}

- (void)setConversationNameTextColor:(UIColor *)conversationNameTextColor
{
    _conversationNameTextColor = conversationNameTextColor;
    self.conversationNameLabel.textColor = _conversationNameTextColor;
}

- (void)setLastMessageFont:(UIFont *)lastMessageFont
{
    _lastMessageFont = lastMessageFont;
    self.lastMessageLabel.font = _lastMessageFont;
}

- (void)setLastMessageTextColor:(UIColor *)lastMessageTextColor
{
    _lastMessageTextColor = lastMessageTextColor;
    self.lastMessageLabel.textColor = _lastMessageTextColor;
}

- (void)setLastMessageStatusFont:(UIFont *)lastMessageStatusFont
{
    _lastMessageStatusFont = lastMessageStatusFont;
    self.lastMessageStatusLabel.font = _lastMessageStatusFont;
}
